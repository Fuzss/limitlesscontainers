    ...
    protected void doClick(int mouseX, int mouseY, ClickType clickType, Player player) {
        ...
        if (clickType == ClickType.QUICK_CRAFT) {
            ...
            if ((i != 1 || this.quickcraftStatus != 2) && i != this.quickcraftStatus) {
                ...
                if (LimitlessContainerUtils.canItemQuickReplace(slot, itemStack, true) && slot.mayPlace(itemStack) && (this.quickcraftType == 2 || itemStack.getCount() > this.quickcraftSlots.size()) && this.canDragTo(slot)) {
                ...
                if (!this.quickcraftSlots.isEmpty()) {
                    ...
                    for (Slot slot2 : this.quickcraftSlots) {
                        ...
                        if (slot2 != null && LimitlessContainerUtils.canItemQuickReplace(slot2, itemStack3, true) && slot2.mayPlace(itemStack3) && (this.quickcraftType == 2 || itemStack3.getCount() >= this.quickcraftSlots.size()) && this.canDragTo(slot2)) {
                            ItemStack itemStack4 = itemStack2.copy();
                            int l = slot2.hasItem() ? slot2.getItem().getCount() : 0;
                            LimitlessContainerUtils.getQuickCraftSlotCount(this.quickcraftSlots, this.quickcraftType, itemStack4, l, slot2);
